...
- **⚠️ Открытый риск:** шаг органики **не выключен явно**. Он держится единственным условием `ozon_downstream_allowed`, и при сборе без хвоста запустится сам — записав завышенную примерно на четверть органику (не собран Selected CPO) и сняв блокер в утреннем алерте. Флага `--skip-organic` в коде нет.
...
|---|---|---|
| Органика не считается | 2026-05-21 | гейт требовал пустого исторического бэклога, чего не бывает. Снят в `34ea2e1`, но Selected CPO не собран → было бы завышено ~на четверть. Явного выключения нет |
...
🔴 1. **Органику выключить явно** — держится случайным условием, см. §0.
