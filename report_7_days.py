...
def print_table(rows):
    print("\n=== Управленческий отчет за последние 7 дней ===\n")
    ...
    print("\n* WB — выкуп по когорте дня заказа: продажи отчёта реализации по дню заказа / заказы воронки того дня; дни моложе 25 суток — прогноз"
          " по последним 30 зрелым дням (WB-11); Ozon — выкупы по дню продажи / созданные заказы.")
